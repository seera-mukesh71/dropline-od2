  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      if (iframe2?.contentWindow) {
        iframe2.contentWindow.postMessage({ type: 'pagechange', page: 'landing' }, '*');
      }
    }, 1000);
  }, []);
        ...
        <div className={styles.main}>
          ...
          <div className={styles.leftCol}>
            ...
            <div className={styles.amountCard}>
              <div className={styles.amountCardIcon}>
                <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#E84E20" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className={styles.rightCol}>
            <div className={styles.illustration}>
              ...
              <span className={styles.sparkle} style={{ top:'20%', right:'4%', fontSize:'12px' }}>✦</span>
              <span className={styles.sparkle} style={{ bottom:'22%', right:'7%', fontSize:'10px' }}>✦</span>
